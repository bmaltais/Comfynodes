...
class ImageMergeNode:
    ...
    def __init__(self):
        # Performance optimization: Initialize FaceMesh model once to avoid reloading on every execution.
        # This significantly speeds up the facial correction process by keeping the model in memory.
